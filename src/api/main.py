...
@app.get("/api/people/intelligence")
...
from src.api.dayone_import_routes import register_dayone_import_routes
register_dayone_import_routes(app, require_any_user)
